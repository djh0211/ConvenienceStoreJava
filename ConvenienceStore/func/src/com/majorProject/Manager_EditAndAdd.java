...
public class Manager_EditAndAdd {
    public HashMap<String, Employee> employeeMap;
    public String path;
    public Manager_EditAndAdd(HashMap<String, Employee> employeeMap, String path){
...
//            System.out.println(uid); // 동일 uid 체크
    ...
    private static void editData(int mode, Employee data, String path) {
    ...
    public static Manager_EditAndAdd getInstance () {
        return new Manager_EditAndAdd(getInstance().employeeMap, getInstance().path);
    }
}
